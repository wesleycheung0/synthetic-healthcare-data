...
code",
    CASE MDCD_ENRLMT_1–
MDCD_ENRLMT WHEN '0' THEN 'No' WHEN '1' THEN 'Yes' WHEN '.' THEN 'Missing' END::ENUM ('No', 'Yes', 'Missing') AS "Medicaid Enrollm ent –
January–Decem ber",
    CASE MDCD_ENRLMT_1–
MDCD_ENRLMT WHEN '0' THEN 'No' WHEN '1' THEN 'Yes' WHEN '.' THEN 'Missing' END::ENUM ('No', 'Yes', 'Missing') AS "Medicaid Enrollm ent –
January–Decem ber",
...
MDCD_ENRLMT WHEN '0' THEN 'No' WHEN '1' THEN 'Yes' WHEN '.' THEN 'Missing' END::ENUM ('No', 'Yes', 'Missing') AS "Medicaid Enrollm ent –
January–Decem ber",
    CASE MDCD_MCO_ENRLMT_1–
MDCD_MCO_ENRLMT WHEN '0' THEN 'No' WHEN '1' THEN 'Yes' WHEN '.' THEN 'Missing' END::ENUM ('No', 'Yes', 'Missing') AS "Medicaid MCO Enrollment – January–
December",
    CASE MDCD_MCO_ENRLMT_1–
MDCD_MCO_ENRLMT WHEN '0' THEN 'No' WHEN '1' THEN 'Yes' WHEN '.' THEN 'Missing' END::ENUM ('No', 'Yes', 'Missing') AS "Medicaid MCO Enrollment – January–
December",
...
MDCD_MCO_ENRLMT WHEN '0' THEN 'No' WHEN '1' THEN 'Yes' WHEN '.' THEN 'Missing' END::ENUM ('No', 'Yes', 'Missing') AS "Medicaid MCO Enrollment – January–
December",
    CASE MDCD_CHIP_ENRLMT WHEN '0' THEN 'Not enrolled in
CHIP' WHEN '1' THEN 'Enrolled in CHIP' WHEN '.' THEN 'Missing' END::ENUM ('Not enrolled in
CHIP', 'Enrolled in CHIP', 'Missing') AS "Medicaid CHIP enrollment – annual",
